...
function pods(prefix: string, pool: string, count: number, node: string, failAt?: number[], pendingAt?: number[]) {
  return Array.from({ length: count }, (_, i) => ({
    name: `${prefix}-${pool}-${i}`,
    pool,
    phase: failAt?.includes(i) ? "Failed" as const : pendingAt?.includes(i) ? "Pending" as const : "Running" as const,
...
export const topologyOverviewMock: TopologyOverviewResponse = {
  ...
  namespaces: [
    {
      ...
      tenants: [
        ...
        },
        {
          ...
          pods: [
            ...pods("beta", "pool-0", 6, "worker-d", [2, 5], [3]),
            ...pods("beta", "pool-1", 6, "worker-e"),
          ],
        },
        {
          name: "gamma-archive",
        ...
        },
        {
          ...
          pods: [
            ...pods("delta-logs", "pool-0", 8, "worker-f"),
            ...pods("delta-logs", "pool-1", 8, "worker-g"),
          ],
        },
      ],
    },
      ...
      tenants: [
        {
          ...
          pods: [
            ...pods("staging-main", "pool-0", 4, "worker-h"),
            ...pods("staging-main", "pool-1", 4, "worker-h"),
          ],
        },
        {
          name: "staging-hotfix",
  ...
  nodes: [
    { name: "worker-a-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "7", memory_allocatable: "28Gi" },
    { name: "worker-a-1", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "7", memory_allocatable: "28Gi" },
    { name: "worker-b-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "7", memory_allocatable: "30Gi" },
    { name: "worker-b-1", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "7", memory_allocatable: "30Gi" },
    { name: "worker-c-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "8", memory_allocatable: "30Gi" },
    { name: "worker-c-1", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "8", memory_allocatable: "30Gi" },
    { name: "worker-d-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "7", memory_allocatable: "28Gi" },
    { name: "worker-e-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "8", memory_allocatable: "30Gi" },
    { name: "worker-f-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "7", memory_allocatable: "29Gi" },
    { name: "worker-g-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "8", memory_allocatable: "30Gi" },
    { name: "worker-h-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "7", memory_allocatable: "28Gi" },
    { name: "worker-i-0", status: "Ready", roles: ["worker"], cpu_capacity: "8", memory_capacity: "32Gi", cpu_allocatable: "8", memory_allocatable: "30Gi" },
  ],
}
